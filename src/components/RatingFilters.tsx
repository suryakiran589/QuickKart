...
const RatingFilters = ({setSelectedRating}:{selectedRating:string,setSelectedRating:any}) => {
   ...
   <div className="border-b-gray-100 border-b-2 pb-2 pl-3 mb-2">
         ...
         { filters.ratings.map((rating) =>{
           return (<div className="flex items-center pb-2">
             <input type="checkbox" name={rating}  value={rating} onChange={(e)=>setSelectedRating((prev:string) => prev ==e.target.value ? "" :e.target.value)}/>
